...
//assert_true(условие) – проверяет, что условие истинно.
//assert_int_equal(a, b) – проверяет равенство двух целых чисел.
//assert_string_equal(a, b) – проверяет равенство строк.
//assert_null(ptr) – проверяет, что указатель NULL.
//assert_non_null(ptr) – проверяет, что указатель не NULL.
