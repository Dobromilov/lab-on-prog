...
3. Запустите программу:
   ...
   ./doubly_linked_list
   ```
# Присваиваем указателям длинного списка, выходящим за короткий NULL (процесс зануления)
```c
#include <stdio.h>
#include <stdlib.h>
...
### **2. Обрезка длинного списка**
- Если один из списков длиннее другого, он обрезается до длины короткого списка.
- Лишние элементы удаляются, а их память освобождается.
